package ada.PsicologyBookings.security.security;


import ada.PsicologyBookings.security.services.impl.JWTUtilityServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                .requestMatchers("/auth/**","/docs/api-docs/**",
                                        "/docs/api-docs.yaml",
                                        "/swagger-ui/**",
                                        "/v3/api-docs/**",
